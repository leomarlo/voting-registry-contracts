...
contract BaseVotingIntegration is IVotingIntegration, SecurityPrimitive {
    ...
    function _afterStart(uint256 identifier) virtual internal {}

    function getVotingContract(uint256 identifier) virtual public returns(address votingContract) {}
