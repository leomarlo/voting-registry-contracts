...
interface VotingWithImplementingInterface extends ethers.utils.Interface {
  functions: {
    "getCurrentIndex()": FunctionFragment;
    "implement(uint256,bytes)": FunctionFragment;
  ...
  events: {
    "Implemented(uint256,bytes)": EventFragment;
    "VotingInstanceStarted(uint256,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Implemented"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "VotingInstanceStarted"): EventFragment;
}

export type ImplementedEvent = TypedEvent<
  [BigNumber, string] & { identifier: BigNumber; callbackData: string }
>;
...
export class VotingWithImplementing extends BaseContract {
  ...
  interface: VotingWithImplementingInterface;
  ...
  filters: {
    "Implemented(uint256,bytes)"(
      identifier?: null,
      callbackData?: null
    ): TypedEventFilter<
      [BigNumber, string],
      { identifier: BigNumber; callbackData: string }
    >;
