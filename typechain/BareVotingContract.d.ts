...
interface BareVotingContractInterface extends ethers.utils.Interface {
  functions: {
...
export class BareVotingContract extends BaseContract {
  ...
  interface: BareVotingContractInterface;
